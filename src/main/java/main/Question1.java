...
public class Question1 {
	public static void main(String[] args){
		...
		case 1:
		{
			...
			System.out.println(es.displayCourseDetails("ECE"));//call the function of the class that you initialized
			break;
		}
		case 2:
		{
		...
		case 3:
		{
			...
			//this case is or CSE
			//Initialize the Class using appropriately taking the concept of inheritence and polymorphism in mind.
			System.out.println(e.displayCourseDetails("CSE"));//call the function of the class that you initialized
			break;
		}
		default:
